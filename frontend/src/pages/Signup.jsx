        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              { selectedFiles &&  <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
                  <img src={previewURL} className="w-full rounded-full" alt="" />
                </figure>}
                <div className="relaitve w-[130px] h-[50px]">
                  <input
                    type="file"
                    name="photo"
