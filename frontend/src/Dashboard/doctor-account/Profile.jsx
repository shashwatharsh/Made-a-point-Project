...
const Profile = ({ doctorData }) => {
  ...
  // resusable funciton for adding items
  ...
  // reusbale input change fucniton
  ...
  const handleQualifincationChange = (Event, index) => {
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="form_input"
                      onChange={(e) => handleQualifincationChange(e, index)}
                    />
                  </div>
                  <div>
